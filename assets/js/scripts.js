function abrirPdf(categoria) {
    switch (categoria) {
        case 'mobiliario':
            window.open('https://docs.google.com/viewerng/viewer?url=https://piacere-warehouseclearencesale.netlify.app/assets/pdf/SESMOBILIARIOREDPDF.pdf&embedded=true', '_blank');
            break;
        case 'cocinas':
